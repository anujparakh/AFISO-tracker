...
RSpec.describe 'Payments Page', type: :feature do
  before :all do
    ...
    Payment.new(payment_amount: 1010, payment_date: DateTime.now, member_id: Member.last.id,
                semester_id: Semester.last.id, officer_id: Officer.last.id).save
  end
  ...
  describe 'Edit Payment' do
    ...
    it 'opens edit page for a payment and changes the name' do
      visit edit_payment_path(Payment.last.id)
      fill_in 'payment_payment_amount', with: 123_456
