...
RSpec.describe 'Transactions Page', type: :feature do
  before :all do
    Transaction.new(transaction_amount: 1010, transaction_type: 'Type1', transaction_date: DateTime.now,
                    officer_id: Officer.last.id).save
  end
  ...
  describe 'Edit Transaction' do
    ...
    it 'opens edit page for a transaction and changes the name' do
      visit edit_transaction_path(Transaction.last.id)
      fill_in 'transaction_transaction_amount', with: 123_456
